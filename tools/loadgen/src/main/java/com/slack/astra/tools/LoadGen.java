...
public class LoadGen {
    ...
    public static void main(String[] args) {
        ...
        final HttpRequest.Builder reqTemplate = HttpRequest.newBuilder()
        ...
        System.out.printf("🌊 Streaming logs to %s (index=%s, batch=%d, every %.3fs). Ctrl+C to stop.%n",
        ...
        while (true) {
            ...
            for (int i = 0; i < batchSize; i++) {
                ...
                ndjson.append("{ \"@timestamp\": \"").append(ts)
                        .append("\", \"level\": \"").append(level)
                        .append("\", \"message\": \"Synthetic log ").append(id)
                        .append("\", \"service-name\": \"test\" }\n");
                id++;
            }

            HttpRequest req = reqTemplate
