...
public class SpanFormatterTest {
    ...
    public void testMakeTraceKV() {
        ...
        Trace.KeyValue actualValue = SpanFormatter.makeTraceKV("error", "test error message", Schema.SchemaFieldType.KEYWORD);
        ...
        assertThat(actualValue.getKey()).isEqualTo(expectedValue.getKey());
        assertThat(actualValue.getVStr()).isEqualTo(expectedValue.getVStr().substring(0, SpanFormatter.MAX_TERM_LENGTH));
    }
